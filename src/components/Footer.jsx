...
const navigation = {
  social: [
    ...
    {
      name: "Instagram",
      // href: "https://www.instagram.com/sadanand_gadwal/",
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    {
      name: "Facebook",
      // href: "https://www.facebook.com/sadanandgadwal7",
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    {
      name: "YouTube",
      // href: "https://youtube.com/@SadanandGadwal",
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    {
      name: "Twitter",
      // href: "https://twitter.com/sadanandgadwal",
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
