...
import Profile from "../images/pankaj.png";
        ...
        <div className="relative isolate -z-10 mt-32 sm:mt-16">
          <div className="mx-auto max-w-[7.5]xl sm:px-6 lg:px-8">
            <div className="mx-auto flex max-w-2xl flex-col gap-16 bg-white/5 px-6 py-16 ring-1 ring-white/10 sm:rounded-3xl sm:p-8 lg:mx-0 lg:max-w-none lg:flex-row lg:items-center lg:py-20 xl:gap-x-20 xl:px-20">
              <img
                className="h-80 w-full flex-none rounded-2xl  shadow-xl lg:aspect-square lg:h-auto lg:max-w-sm object-contain scale-75"
                src={Profile}
                alt="Image"
              />
              <div className="w-full flex-auto">
                ...
                <p className="mt-6 text-lg leading-8 text-gray-300">
                  I am a passionate Full Stack Web Developer specializing in the MERN stack (MongoDB, Express.js, React.js, and Node.js). Currently, I am Working as Software Developer intern in Baioam innovation pvt.ltd., I have completed my master's in MCA from the Central University of Karnataka, Kalaburagi. With a strong focus on web development, I possess expertise in technologies such as React.js, tailwind css, Material UI etc. However, my skills are not limited to these programming languages, as I am a fast learner and can adapt to new stacks based on project requirements.
                </p>
{/*                  I am confident that my passion for web development and my ability to quickly grasp new technologies make me a strong candidate for any company. */}
                {/* <ul
                  role="list"
                ...
                >
                  {skills.map((benefit) => (
                    <li key={benefit} className="flex gap-x-3">
                      <span
                        className="h-7 w-7 flex-none rounded-[50%] bg-green-200"
                        aria-hidden="true"
                      />
                      {benefit}
                    </li>
