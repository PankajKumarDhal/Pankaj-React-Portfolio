...
function Home() {
  return (
    <>
      <div
        className="min-h-screen bg-cover bg-no-repeat object-cover bg-fixed bg-center"
        style={{
...
{/*             <div className="flex justify-center">
              <img
                className="w-44 h-44 object-cover rounded-full ring-2 ring-gray-300 dark:ring-gray-500"
                src={profilelogo}
                alt="Bordered avatar"
              />
              "https://static.vecteezy.com/system/resources/previews/023/713/274/non_2x/3d-illustration-of-a-cartoon-character-with-a-laptop-on-orange-background-generative-ai-free-photo.jpg"
            </div> */}
            <p className="text-4xl text-white  sm:text-6xl">
              Hello, I'm{" "}
              <span className="text-orange-300 font-bold text-center  sm:text-6xl">
                {" "}
                Pankaj Kumar Dhal
              </span>
            </p>
            <br />
            <p className="text-4xl text-white flex items-center  sm:text-6xl justify-center">
              {" "}
            ...
            <div className="wrapper">
              ...
              <Link to="About Me" smooth="true" className="ct">
                <a
                  href="#_"
                  class="relative inline-flex items-center justify-center p-4 px-6 py-3 overflow-hidden font-medium text-white-600 transition duration-300 ease-out border-2 border-white-500 rounded-full shadow-md group"
                >
                  <span class="absolute inset-0 flex items-center justify-center w-full h-full text-white duration-300 -translate-x-full bg-white-500 group-hover:translate-x-0 ease">
                    <svg
                      class="w-6 h-6"
                      fill="none"
                      stroke="currentColor"
